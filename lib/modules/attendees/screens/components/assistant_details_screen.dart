...
import 'add_note_assistant_screen.dart';
import 'send_message.dart';

class AssistantDetailsScreen extends StatelessWidget {
  const AssistantDetailsScreen({Key? key}) : super(key: key);
                ...
                IconButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const AddNoteAssistant()),
                      );
                    },
