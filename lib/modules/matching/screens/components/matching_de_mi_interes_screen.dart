...
import '../../../asistentes/screens/components/asistentes_details_screen.dart';

class DeMiInteresScreen extends StatelessWidget {
  const DeMiInteresScreen({Key? key}) : super(key: key);
